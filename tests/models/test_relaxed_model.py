...
def test_solve_relaxed_hit_model(simple_df, slack):
    ...
    # Assert
    _, true_positives_removed, _ = check_hit_solution(simple_df, cutoffs, validate=False)
...
def test_solve_simple_payment_model_using_mip(simple_df, slack):
    ...
    # Assert
    n_payment_hits, true_positives_removed, _ = check_payment_solution(simple_df, cutoffs, validate=False)
