...
hatch run relaxed --solver_name='GUROBI' --model_type='hit' --slacks="0.95, 0.96, 0.97, 0.98, 0.99, 0.995, 0.999"
...
hatch run relaxed --solver_name='GUROBI' --model_type='payment' --slacks="0.95, 0.96, 0.97, 0.98, 0.99, 0.995, 0.999"
